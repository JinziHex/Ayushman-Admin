                    ...
                    <form action="{{ route('invoice-settlemnt.store', ['id' => $invoice->id]) }}" id="addFm" method="POST" enctype="multipart/form-data"  onsubmit="return validateForm()">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control discount" name="discount_amount" id="discount_amount" placeholder="Discount Amount" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control paid-amount" name="paid_amount" id="paid_amount" placeholder="Total Amount" required readonly>
                            </div>
                        </div>
                    </div>
    ...
    document.querySelectorAll('.paid-amount').forEach(function(input) {
        input.addEventListener('keypress', function(event) {
            ...
            if (event.keyCode >= 48 && event.keyCode <= 57) {
                ...
                event.preventDefault(); // Prevent typing characters
            }
        });
    });
});
