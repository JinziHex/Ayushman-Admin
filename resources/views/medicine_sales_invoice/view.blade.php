                              ...
                              <table class="table card-table table-vcenter text-nowrap" id="productTable">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td class="medicine-rate"><input type="text" class="form-control" value="{{ number_format($sale_details->rate,2)}}" readonly></td>
                                       <td class="medicine-amount"><input type="text" class="form-control" value="{{number_format($sale_details->amount,2)}}" readonly></td>
                              ...
                              <div class="card-body">
                                 <table style="width: 100%;">
                                    <tr>
                                       ...
                                       <td style="text-align: right;"><strong class="tot"></strong><input type="hidden" id="sub-total-input" name="sub_total_amount">{{number_format($medicine_sale_invoices->sub_total,2)}}</td>
                                    </tr>
                                    <tr>
                                       <td><strong>Tax Amount</strong></td>
                                       <td style="text-align: right;"><strong class="tax-amount"></strong><input type="hidden" id="tax-amount-input" name="total_tax_amount">{{number_format($medicine_sale_invoices->total_tax_amount,2)}}</td>
                                    </tr>
                                    <tr>
                                       <td><strong>Total Amount</strong></td>
                                       <td style="text-align: right;"><strong class=""></strong><input type="hidden" name="total_amount">{{number_format($medicine_sale_invoices->total_amount,2)}}</td>
                                    </tr>
                                    <tr>
                                       <td><strong>Discount Amount</strong></td>
                                       <td style="text-align: right;"><strong class="discount-amount"></strong><input type="hidden" id="discount-amount-input" name="discount_amount">{{number_format($medicine_sale_invoices->discount_amount,2)}}</td>
                                    </tr>
                                 </table>
                                 <hr>
                                 <div class="form-group mb-2"> <!-- Decreased margin height -->
                                    <label class="form-label payable-amount">Payable Amount : <b>{{number_format($medicine_sale_invoices->payable_amount,2)}}</b></label>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" id="paid_amount_{{$patymentDetail->id}}" class="form-control paid-amount" name="paid_amount[]" readonly value="{{ number_format($patymentDetail->payable_amount,2)}}">
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
