                                ...
                                <div class="card">
									...
									<div class="card-body">
										<div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <span class="form-label">Booking Date & Slot: {{ $patient->booking_date }} | {{ (optional(optional($patient->staffTimeslot)->timeSlot)->slot_name ?: 'No timeslot selected') . ': ' . 
                                                       (optional(optional($patient->staffTimeslot)->timeSlot)->time_from ?: '') . '-' . 
                                                       (optional(optional($patient->staffTimeslot)->timeSlot)->time_to ?: '') }}</span>
                                            </div>
                                            <div class="col-md-4">
                                                <span class="form-label">Token Number:  {{ $patient->token_number ?? 0 }}
 </span>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                <span class="form-label">Booking Created Date: {{ $patient->created_at->format('Y-m-d') }} </span>
                                            </div>
