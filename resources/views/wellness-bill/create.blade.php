        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="col-lg-12" style="background-color: #fff;">
                    ...
                    @endif
                    <form action="{{ route('wellness-bill.store', ['id' => $booking_id]) }}" onsubmit = "return validateForm()"  id="addFm" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control paid-amount" name="paid_amount" id="paid_amount" maxlength="16" value="{{ $invoice->booking_fee }}" readonly placeholder="Paid Amount">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control paid-amount" name="paid-amount" value="{{ $invoice->booking_fee }}" id="amount" placeholder="Total Amount" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row cloneDiv" id="cloneDiv">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control paid-amount" name="amount[]" value="{{ $invoice->booking_fee }}" id="amount" placeholder="Total Amount" >
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <select class="form-control payment_mode"  name="payment_mode[]" placeholder="Payment Mode" id="payment_mode">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var errorMsg = document.getElementById("error-msg");
    var maxDiscount = parseFloat(discountInput.getAttribute("data-discount"));
    var payd = document.querySelector('[name="amount[]"]');
    ...
    function calculateTotalAmount() {
        ...
        if (isNaN(discount) || discount === 0) {
            ...
            payd.value = paidAmount.toFixed(2);
        } else {
            var totalAmount = paidAmount - (paidAmount * discount / 100);
            totalAmountInput.value = totalAmount.toFixed(2);
            payd.value = totalAmount.toFixed(2);
        }
    }
