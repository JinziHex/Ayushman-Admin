                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id ="contactnumber" max="9999999999" min="1000000000" required name="phone_1" value="{{ old('phone_1') }}" placeholder="Phone Number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Alternative Mobile Number</label>
                                    <input type="number" max="9999999999" min="1000000000" id="alternativenumber" class="form-control" name="phone_2" value="{{ old('phone_2') }}" placeholder="Alternative Number">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<script>
    ...
    $(document).ready(function () {
      ...
      var alternativenumber = document.getElementById('alternativenumber');

  alternativenumber.addEventListener('input', function() {
    if (alternativenumber.validity.rangeUnderflow) {
      alternativenumber.setCustomValidity('Please enter a valid contact number.');
    } else if (alternativenumber.validity.rangeOverflow) {
      alternativenumber.setCustomValidity('Please enter a valid contact number.');
    } else {
      alternativenumber.setCustomValidity('');
    }
  });
        var contactnumber = document.getElementById('contactnumber');

  contactnumber.addEventListener('input', function() {
    if (contactnumber.validity.rangeUnderflow) {
      contactnumber.setCustomValidity('Please enter a valid contact number.');
    } else if (contactnumber.validity.rangeOverflow) {
      contactnumber.setCustomValidity('Please enter a valid contact number.');
    } else {
