                     ...
                     <div class="col-md-3">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" value="{{ isset($medicine_sale_invoices->Invoice['sales_invoice_number']) ? $medicine_sale_invoices->Invoice['sales_invoice_number'] : 'N/A' }}" readonly name="due_date" placeholder="Date">                        </div>
                     </div>
                           ...
                           <div class="card card-ash-border">
                              ...
                              <table style="width: 100%;">
                                 ...
                                 <div class="form-group mb-2"> <!-- Decreased margin height -->
                                    ...
                                    <label class="form-label payable-amount">Payable Amount : <b>{{$medicine_sale_invoices->total_amount - $medicine_sale_invoices->total_discount ? number_format($medicine_sale_invoices->total_amount - $medicine_sale_invoices->total_discount, 2) : '0.00'}}</b></label>
                                 </div>
                              </div>
                           </div>
                        </div>
