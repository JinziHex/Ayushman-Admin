                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <input type="text" class="form-control net_earnings" required
                                                    name="net_earnings" placeholder="Net Earnings" value="{{number_format(@$salary_process->net_earnings,2)}}" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <input type="text" class="form-control net_earnings" required
                                                    name="net_earnings" placeholder="Net Earnings" value="{{number_format(@$salary_process->paid_amount,2)}}" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6"><label class="form-label">Remaining Amount</label>
                                            </div>
                                            <div class="col-6">
                                                <input type="text" class="form-control net_earnings" required
                                                    name="net_earnings" placeholder="Net Earnings" value="{{number_format(@$salary_process->net_earnings-@$salary_process->paid_amount,2)}}" readonly>
                                            </div>
                                        </div>
