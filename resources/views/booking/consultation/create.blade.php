                     ...
                     <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control discount numericInputvalue" name="discount_total" id="discount_Total" placeholder="Discount Amount" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control paid-amount numericInputvalue" name="paid_amount" id="paid_amount" placeholder="Total Amount" required readonly>
                            </div>
                        </div>
                    </div>
                  ...
                  Swal.fire(data.error);
                      ...
                      $('#timeslots').val();
                       ...
                       $.each(data.timeslots, function(key, value) {
                           var optionText = value.slot_name + ' : ' + value.time_from + ' - ' + value.time_to + ' (Available Tokens: ' + value.available_tokens + ')';
      ...
      $(document).ready(function() { 
        ...
        $('#addRow').click(function(){
           // alert("test")
            ...
            newRow.find('select').removeAttr('required');
...
function validateForm() {
    ...
    $('input[name="payable_amount[]"]').each(function() {
        if(!$(this).val()) {
            $(this).closest("#paymentdiv").remove()
        }
        total += parseFloat($(this).val()) || 0;
