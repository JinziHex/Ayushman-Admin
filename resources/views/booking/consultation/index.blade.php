        ...
        <div class="col-md-12 col-lg-12">
            <button class="btn btn-blue displayfilter"><i class="fa fa-filter" aria-hidden="true"></i>
             ...
             <div class="card displaycard ShowFilterBox">
                ...
                <form action="{{route('bookings.consultation.index')}}" method="GET" class="card-body">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <tbody>
                                ...
                                @foreach ($bookings as $key => $booking)
                                    <tr id="">
                                        ...
                                        <td>{{ (optional(optional($booking->staffTimeslot)->timeSlot)->slot_name ?: 'No timeslot selected') . ': ' . 
                                                           (optional(optional($booking->staffTimeslot)->timeSlot)->time_from ?: '') . '-' . 
                                                           (optional(optional($booking->staffTimeslot)->timeSlot)->time_to ?: '') }}</td>
