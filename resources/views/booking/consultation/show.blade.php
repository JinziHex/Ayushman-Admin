										...
										<div class="row">
                                            ...
                                            <div class="col-md-4">
                                               <span class="form-label">
                                                Timeslot: {{ (optional(optional($patient->staffTimeslot)->timeSlot)->slot_name ?: 'No timeslot selected') . ': ' . 
                                                           (optional(optional($patient->staffTimeslot)->timeSlot)->time_from ?: '') . '-' . 
                                                           (optional(optional($patient->staffTimeslot)->timeSlot)->time_to ?: '') }}
                                            </span>
                                            </div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-4">
                                                <span class="form-label">Token Number: {{ $patient->token_number ?? 0 }}</span>
                                            </div>
                                             </div>
                                            <div class="row">
                                            <div class="col-md-4">
