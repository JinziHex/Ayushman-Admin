        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="col-lg-12" style="background-color: #fff;">
                    ...
                    @endif
                    <form action="{{route('wellness.update',['wellness_id'=>$wellness->wellness_id])}}" method="POST" enctype="multipart/form-data" id="myForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                                <div class="form-group checkbox">
                                    ...
                                    <input type="file" class="form-control" name="wellness_image" placeholder="Wellness Image" accept="image/jpeg,image/png,image/jpg">
                              ...
                              <div class="col-md-6">
                                <div class="form-group checkbox">
                                    ...
                                    <select class="multi-select" required name="branch[]" multiple style="width: 100%;">
                                        ...
                                        <option value="{{ $branchName->id }}" {{ $branch_ids->contains($branchName->id) ? 'selected' : '' }}>
                                            {{ $branchName->pharmacy_name }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
    ...
    $("#your-form-id").validate({
        ...
        messages: {
            wellness_image: {
                ...
                extension: "Please enter a value with a valid extension (png, jpg, jpeg)"
            }
        }
    });
});
