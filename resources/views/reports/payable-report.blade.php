                ...
                <table id="report" class="table table-striped table-bordered text-nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr id="dataRow_{{ $purchases->supplier_id  }}">
                            ...
                            <td>{{ isset($purchases->total_payable_amount) ? number_format($purchases->total_payable_amount, 2) : '0.00' }}</td>
                            <td>{{ isset($purchases->total_paid_amount) ? number_format($purchases->total_paid_amount, 2) : '0.00' }}</td>
                            <td>{{ isset($purchases->balance_due) ? number_format($purchases->balance_due, 2) : '0.00' }}</td>
