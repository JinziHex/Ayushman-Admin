                            ...
                            <tbody>
                                ...
                                @foreach ($sales_details as $key => $sales_detail)
                                    <tr id="dataRow_{{ $sales_detail->sales_invoice_details_id }}">
                                        ...
                                        <td>{{ intval($sales_detail->quantity ?? 0) }}</td>
                                        <td>{{ number_format($sales_detail->rate,2) }}</td>
                                        <td>{{  number_format($sales_detail->med_quantity_tax_amount,2) }}</td>
                                        <td>{{ number_format($sales_detail->amount,2) }}</td>
