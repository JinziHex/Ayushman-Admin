                ...
                <table id="report" class="table table-striped table-bordered text-nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr id="dataRow_{{ $purchases->purchase_invoice_id  }}">
                            ...
                            <td>{{ isset($purchases->total_amount) ? number_format($purchases->total_amount, 2) : '0.00' }}</td>
                            <td>{{ isset($purchases->paid_amount) ? number_format($purchases->paid_amount, 2) : '0.00' }}</td>
                            <td>{{ number_format($purchases->total_amount - $purchases->paid_amount, 2) }}</td>
