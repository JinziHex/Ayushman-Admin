                            ...
                            <tbody>
                                ...
                                @foreach ($purchase_details as $key => $purchase_detail)
                                    <tr id="dataRow_{{ $purchase_detail->purchase_invoice_details_id  }}">
                                        ...
                                        <td> {{ isset($purchase_detail->total_amount) ? number_format($purchase_detail->total_amount, 2) : '0.00' }}</td>
                                        <td>{{ isset($purchase_detail->paid_amount) ? number_format($purchase_detail->paid_amount, 2) : '0.00' }}</td>
                                        <td>{{ number_format(@$purchase_detail->total_amount-@$purchase_detail->paid_amount,2) }}</td>   
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
