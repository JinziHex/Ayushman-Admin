                ...
                <div class="col-lg-12" style="background-color: #fff;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text"  class="form-control paid-amount" name="discount" id="discount" placeholder="Discount Percentage" data-discount="{{ $discount }}" oninput=" this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1'); ">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control discountAmounts" id="amountDiscount" placeholder="Discount Amount" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control discountAmount"  readonly name="discountAmount" id="discountAmount" placeholder="Discount Percentage" data-discount="{{ $discount }}">
                ...
                <div class="row cloneDiv" id="cloneDiv">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control paid-amount" name="amount[]" id="amount" placeholder="Total Amount"  oninput=" this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1'); ">
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $(document).on('input', 'input[name="amount[]"]', function() {
        ...
        $('input[name="amount[]"]').each(function() {
            total += parseFloat($(this).val()) || 0; // convert to number and add, handle empty values
        });
        
        var paidAmount = parseFloat($("#paid_amount").val()) || 0;
        var amountDiscount = parseFloat($("#amountDiscount").val()) || 0;
        var remainingAmount = paidAmount - amountDiscount;
    ...
    totalBookingFee=totalBookingFee.toFixed(2)
    
    if (total !== totalBookingFee) {
        alert("Total payable amount should be " + totalBookingFee.toFixed(2));
        isValid = false;
    }
    // else {
    //     alert("test")
    ...
    function validateInput(input) {
        ...
        // var numericValue = inputValue.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1'); 
