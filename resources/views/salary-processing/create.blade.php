                                    ...
                                    <div class="form-group">
                                       ...
                                       @if(Auth::user()->user_type_id == 1)
                                        @if(session()->has('pharmacy_id') && session()->has('pharmacy_name') && session('pharmacy_id') != "all")
                                            ...
                                            @endphp
                                            <select class="form-control" required name="branch_id" id="branch" readonly="">
                                ...
                                <div class="col-md-6" style="border-right: 1px solid #0d97c6;">
                                    ...
                                    <div class="form-group" style="margin-top: 1rem">
                                        <div class="row">
                                         ...
                                         <div class="form-group" style="margin-top: 1rem">
                                        <div class="row">
                                            <div class="col-4"><label class="form-label">Commission</label>
                                            </div>
                                            <div class="col-8">
                                                <input type="text" class="form-control commission"  id="commission" name="commission" placeholder="Commission">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                   <label class="form-label">Reference Number</label>
                                    <input type="text" class="form-control reference_number"
  ...
  <script>
    ...
    <script>
        ...
        function updateNetEarnings() {
            ...
            var totalEarnings = 0;
            setTimeout(function() {
            $('.bonus, .overtime, .other_earnings, .earning_head, .commission').each(function() {
                var amount = parseFloat($(this).val());
                if (!isNaN(amount)) {
                  //  console.log(amount)
            ...
            $('.net_earnings').val(totalEarnings.toFixed(2));
            }, 500);
        }
        });
    </script>
