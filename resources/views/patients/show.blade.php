                     ...
                     <div class="table-responsive ">
                        <table class="table row table-borderless">
                           <tbody class="col-lg-12 col-xl-6 p-0">
                              ...
                              <tr>
                                 <td><strong>Date Of Birth :</strong> {{ $show->patient_dob ?? 'Nill'}}</td>
                              </tr>
             
                              <tr>
                                 <td><strong>Emergency Contact Person:</strong> {{ $show->emergency_contact_person ??'Nill'}}</td>
                              </tr>
                              <tr>
                                 <td><strong>Emergency Contact :</strong> {{ $show->emergency_contact ??'Nill'}}</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <td><strong>Whatsapp Number:</strong> {{ $show->whatsapp_number ??'Nill'}}</td>
                              </tr>
                                <tr>
                                 <td><strong>Gender:</strong> {{ $show->gender_value ??'Nill'}}</td>
                              </tr>
                            <tr>
                                 <td><strong>Blood Group:</strong> {{ $show->blood_group_value ??'Nill'}}</td>
                              </tr>
                              
                            <tr>
                                 <td><strong>Registered Date:</strong> {{ $show->updated_at ??'Nill'}}</td>
                              </tr>
                                <tr>
                                 <td><strong>Marital status:</strong> {{ $show->marital_status_value ??'Nill'}}</td>
                              </tr>
                            <tr>
                                 <td><strong>Medical History:</strong> {!! $show->patient_medical_history ?? 'Nill' !!}</td>
 
                              </tr>
                            <tr>
                                 <td><strong>Current medications:</strong>{!! $show->patient_current_medications ?? 'Nill' !!}</td> 
                              </tr>
                           </tbody>
