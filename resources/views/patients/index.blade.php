                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" id="patient-code" name="patient_code" class="form-control" value="{{ request('patient_code') }}" Placeholder="Patient Code">
                        </div>
                        <div class="col-md-4">
                            <label for="patient-name" class="form-label">Patient Name</label>
                            <input type="text" id="patient-name" name="patient_name" class="form-control" value="{{ request('patient_name') }}" Placeholder="Patient Name">
                        </div>
                        <div class="col-md-4">
                            <label for="patient-mobile" class="form-label">Patient Mobile</label>
                            <input type="text" id="patient-mobile" name="patient_mobile" class="form-control numericInput"  maxlength="10" oninput="validateInput(this)"  value="{{ request('patient_mobile') }}" Placeholder="Patient Mobile">
                        </div>
                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response == '1') {
                                ...
                                if (cell.find('.btn-success').length) {
                                    cell.html('<button type="button" onclick="changeVerification(' + dataId + ')" class="btn btn-sm btn-danger">Not  Verified</button>');
                                } else {
