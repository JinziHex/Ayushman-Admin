            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-control mt-2" name="patient_name" id="patient_name">
                            ...
                            @foreach($patientLists as $patientList)
                                <option value="{{ $patientList->patient_name }}" {{ old('patient_name', $selectedPatient) == $patientList->patient_name ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" id="booking_date" name="booking_date" class="form-control" value="{{ old('booking_date', $selectedDate) }}">
                    </div>
                </div>
