                ...
                <div class="row cloneDiv" id="cloneDiv">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control paid-amount" name="amount[]" id="amount" value="{{ $invoice->booking_fee }}" placeholder="Total Amount" oninput=" this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1'); ">
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $(document).ready(function() { 
        $('#addRow').click(function(){
            ...
            newRow.find('select').attr("required", false);
