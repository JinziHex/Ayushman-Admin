		...
		<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
			<div class="card bg-success img-card box-success-shadow">
				<div class="card-body bg-transparent">
					<div class="d-flex">
						<div class="text-white">
							<h2 class="mb-0 number-font">{{@$monthlyPurchase->monthly_purchase ?? '0'}}</h2>
							<p class="text-white mb-0" style="font-size:12px;">Monthly Purchase</p>
						</div>
						<div class="ml-auto">
							<i class="fa fa-bar-chart text-white fs-30 mr-2 mt-2"></i>
						</div>
		...
		<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
			<div class="card bg-success img-card box-success-shadow">
				<div class="card-body bg-transparent">
					<div class="d-flex">
						<div class="text-white">
							<h2 class="mb-0 number-font">{{@$creditSales ?? '0'}}</h2>
							<p class="text-white mb-0" style="font-size:12px;">Count of Credit Sales </p>
						</div>
						<div class="ml-auto">
							<i class="fa fa-bar-chart text-white fs-30 mr-2 mt-2"></i>
						</div>
