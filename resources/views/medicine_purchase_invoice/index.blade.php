                        ...
                        @endif
                            ...
                            <select class="form-control" name="supplier_id" id="supplier_id">
                                ...
                                @foreach($suppliers as  $data)
                                    <option value="{{ $data->supplier_id  }}" }} {{ request('supplier_id') == $data->supplier_id ? 'selected' : '' }}>{{ $data->supplier_name }} </option>
                                @endforeach
                            </select>
                        </div>
            ...
            <tbody>
               ...
               <tr id="dataRow_{{ $invoice->purchase_invoice_id }}">
                  ...
                  <td> {{ isset($invoice->total_amount) ? number_format($invoice->total_amount, 2) : '0.00' }}</td>
                     <td> {{ isset($invoice->paid_amount) ? number_format($invoice->paid_amount, 2) : '0.00' }}</td>
