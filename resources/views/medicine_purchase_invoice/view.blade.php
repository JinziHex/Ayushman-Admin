                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly disabled
                                        value="{{ number_format(@$purchase_invoice->paid_amount, 2) }}"> 
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly disabled
                                        value="{{ number_format(@$purchase_invoice->total_amount, 2) }}"> 
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly disabled
                                        value="{{ number_format($creditLimit,2) }}"> 
                                </div>
                            </div>
                                        ...
                                        <table
                                            ...
                                            <thead class="bg-gray-dark text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-white">MRP(INCLUDING TAX)</th>
                                                    <th class="text-white">Purchase Rate</th>
                                                    <th class="text-white">Purchase MRP</th>
                                            ...
                                            <tbody>
                                                @foreach ($purchase_invoice->purchaseInvoiceDetails as $key => $item)
                                                   ...
                                                   <td>{{ number_format($item->quantity, 0) }}</td>
                                                        ...
                                                        <td>{{ number_format(@$item->purchase_mrp, 2) }}</td> 
                                                        ...
                                                        <td>{{ isset($item->discount) ? number_format($item->discount, 2) : '0.00' }}</td>
                                                        <td>{{ isset($item->tax_amount) ? number_format($item->tax_amount, 2) : '0.00' }}</td>
