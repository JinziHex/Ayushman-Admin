...
class TrnJournelEntryController extends Controller
{
    ...
    {
        $query = Trn_staff_cash_deposit::orderBy('created_at', 'DESC')
    ...
    $processDatas = $query->get(['trn_staff_cash_deposits.*', 'mst_branches.branch_name', 'from_ledger.ledger_name as from_account', 'to_ledger.ledger_name as to_account']);
