...
class AvailableLeaveController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = EmployeeAvailableLeave::select('mst_staffs.staff_name','mst_staffs.branch_id','mst_branches.branch_name', 'employee_available_leaves.*')
            ->leftJoin('mst_staffs', 'employee_available_leaves.staff_id', '=', 'mst_staffs.staff_id')
            ->leftJoin('mst_branches', 'mst_staffs.branch_id', '=', 'mst_branches.branch_id');
